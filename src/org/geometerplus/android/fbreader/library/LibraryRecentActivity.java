...
public class LibraryRecentActivity extends LibraryBaseActivity {
    ...
    private TopLevelTreeRecent mySearchResultsItem;
...
//        myItems.add(new TopLevelTreeRecent(
...
//                        super.run();
//                    } else {
//                        UIUtil.showErrorMessage(LibraryRecentActivity.this, "noFavorites");
//                    }
//                }
//            })
//        ));
...
//                public void run() {
//                    startActivity(
//                        new Intent(LibraryRecentActivity.this, FileManager.class)
...
//        ));
        ...
        TopLevelTreeRecent tree = (TopLevelTreeRecent)((LibraryAdapter)getListAdapter()).getItem(0);
        tree.run();       
    ...
    public void onListItemClick(ListView listView, View view, int position, long rowId) {
        TopLevelTreeRecent tree = (TopLevelTreeRecent)((LibraryAdapter)getListAdapter()).getItem(position);
        tree.run();
    }
    ...
    private void setSearchResults(Intent intent) {
        ...
        mySearchResultsItem = new TopLevelTreeRecent(
...
class TopLevelTreeRecent extends FBTree implements ZLAndroidTree {
    private final ZLResource myResource;
    private final String myParameter;
    private final int myCoverResourceId;
    private final Runnable myAction;

    public TopLevelTreeRecent(ZLResource resource, String parameter, int coverResourceId, Runnable action) {
        myResource = resource;
    ...
    public TopLevelTreeRecent(ZLResource resource, int coverResourceId, Runnable action) {
